...
var swipersData = [
  { swiperId: 4, swiperImgSrc: "/images/wx.png"},
  { swiperId: 5, swiperImgSrc: "/images/vr.png"},
  { swiperId: 6, swiperImgSrc: "/images/iqiyi.png"}
];
// for(let ele in local_database) {
//   if (ele == 3 || ele == 4 || ele == 5) {
//     swipersData.push(local_database[ele]);
//   }
// }
//定义向外暴露的接口（或变量）
module.exports = { 
